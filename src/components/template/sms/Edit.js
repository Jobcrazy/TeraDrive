...
class UserEdit extends React.Component {
    ...
    componentDidMount() {
        window.document.title = "SMS - Template - TeraDrive";
    ...
    onFinish(values) {
        ...
        let url = "api/template/sms/create";
        if ("0" !== this.id) {
            url = "api/template/sms/update";
        }
        ...
        axios({
            ...
            .then(function (res) {
                ...
                if (1 === res.data.code) {
                    ...
                    self.props.history.push("/main/templates/sms");
                } else {
                    message.error(res.data.message);
                }
            })
        ...
        return (
            <Col span="24" style={{ backgroundColor: "#fff" }}>
                ...
                >
                    ...
                    >
                        <Input placeholder="SMS Template Name" />
                    </Form.Item>
